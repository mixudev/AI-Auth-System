...
class PermissionManagementController extends Controller
{
    ...
    public function index(Request $request): View
    {
        ...
        return view('admin.dashboard.role-permission.permission.index', 
    ...
    public function create(): View
    {
        ...
        $groups = Permission::distinct('group')->pluck('group');
        return view('admin.dashboard.role-permission.permission.create', compact('groups'));
    }
    ...
    public function edit(Permission $permission): View
    {
        ...
        $groups = Permission::distinct('group')->pluck('group');
        return view('admin.dashboard.role-permission.permission.edit', 
