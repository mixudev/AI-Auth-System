...
class RoleManagementController extends Controller
{
    ...
    public function index(Request $request): View
    {
        ...
        return view('admin.dashboard.role-permission.role.index', compact('roles', 'stats', 'filters'));
    }
    ...
    public function create(): View
    {
        ...
        return view('admin.dashboard.role-permission.role.create', compact('permissions'));
    }
    ...
    public function edit(Role $role): View
    {
        ...
        return view('admin.dashboard.role-permission.role.edit', compact('role', 'permissions', 'rolePermissions'));
    }
