...
class EnsureSessionVersionMiddleware
{
    ...
    */
    ...
    public function handle(Request $request, Closure $next): Response
    {
        ...
        // Session version hanya boleh di-set oleh completeAuthenticatedSession()
        ...
        // Versi sesi tidak cocok → sesi sudah dicabut (misal: password diganti, logout semua perangkat)
