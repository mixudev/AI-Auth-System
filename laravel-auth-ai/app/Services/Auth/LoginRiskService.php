...
class LoginRiskService
{
    ...
    */
     ...
     *
     * Tidak lagi binary (0.2 vs 1.0), melainkan proporsional berdasarkan:
     * - Apakah record ada di trusted_devices
     * - Apakah sudah revoked atau expired
     * - Berapa sisa hari kepercayaan (semakin lama tersisa → skor makin tinggi)
     *
