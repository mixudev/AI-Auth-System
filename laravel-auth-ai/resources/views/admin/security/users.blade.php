      ...
      <table>
        <thead>
          <tr>
            ...
            <th>Last Login</th><th>Last IP</th><th>Last Country</th><th>Device</th><th>Logs</th><th>Devices</th>
            <th>Created</th><th>Status</th><th>Action</th>
          </tr>
        </thead>
        <tbody id="tb-users">
          <tr class="state-row"><td colspan="14"><span class="spinner"></span>Loading…</td></tr>
        </tbody>
      </table>
    </div>
  </div>
